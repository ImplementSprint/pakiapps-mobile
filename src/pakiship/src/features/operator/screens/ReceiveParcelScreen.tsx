...
import { fetchPendingParcels, receiveParcel, fetchHubSummary, dispatchParcel } from "../services/operatorApi";
      ...
      <Modal visible={showSuccess} transparent animationType="slide" onRequestClose={() => { setShowSuccess(false); setScanParcel(null); }}>
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalSheet}>
            ...
            <Text style={styles.successTitle}>Received & Dispatched!</Text>
            <Text style={styles.successSubtitle}>Parcel has been received and automatically dispatched to driver.</Text>
