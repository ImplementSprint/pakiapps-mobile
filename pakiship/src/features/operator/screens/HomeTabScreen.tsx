    ...
    <View style={styles.container}>
      ...
      <CameraModal
        ...
        onSuccess={async (trackingNumber) => {
          setShowCamera(false);
          try {
            await scanQrCode(trackingNumber);
            fetchDashboard();
            Alert.alert("Success", `Parcel scanned and registered successfully.`, [
      ...
      >
        ...
        {(() => {
          const pct = hubSummary?.capacityPercentage ?? hubSummary?.capacity ?? 0;
          const fillColor = pct >= 90 ? COLORS.red : COLORS.orange;
